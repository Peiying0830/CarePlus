...
<nav class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-buttons">
            ...
            <a href="registration.php" class="nav-btn nav-btn-register">Register</a>
        </div>
    </div>
</nav>
...
<div id="chatbot-box">
    <div class="chatbot-header">
        <span>CarePlus AI Assistant</span>
        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <div class="hero-buttons">
                    ...
                    <a href="login.php" class="btn btn-secondary">🤖 AI Symptom Checker</a>
                </div>
            </div>
        </div>
    </div>
